<footer class="footer">
    ...
    <div class="container copy-right">
        ...
        <span>Copyright © <a href="#">{{ config('web_site_name') }}</a> <a href="http://www.miitbeian.gov.cn/" target="_blank">{{ config('web_ record') }}</a>
            &nbsp;&nbsp;<em class="bull-right">本站由</em><i class="icon-aliyun" style="width: 70px;background-size: 100%;left: 7px;"></i><em class="bull-em">提供计算与安全服务</em>
        </span>
